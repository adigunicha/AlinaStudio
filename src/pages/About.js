...
const About = () => {
  return (
    <motion.section initial={{opacity:0,y:'100%'}} animate={{opacity:1,y:0}} exit={{opacity:0,y:'100%'}} transition={transition1} className='pt-24 md:pt-52 p-4   md:pl-36'>
      <div className='flex md:gap-16 gap-5 flex-col-reverse md:flex-row'>
       <div className=' md:mt-[-6rem] flex justify-center bg-accent'>
